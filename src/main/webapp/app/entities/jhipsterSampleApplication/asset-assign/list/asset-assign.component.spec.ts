...
describe('AssetAssign Management Component', () => {
  let comp: AssetAssignComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'jhipstersampleapplication/asset-assign', component: AssetAssignComponent }]),
      ...
      .overrideTemplate(AssetAssignComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.assetAssigns?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
