...
export class ContinentComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.continentService
      ...
      .subscribe({
        next: (res: HttpResponse<IContinent[]>) => {
  ...
  trackId(_index: number, item: IContinent): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: IContinent[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
    this.totalItems = Number(headers.get('X-Total-Count'));
    this.page = page;
    if (navigate) {
      this.router.navigate(['/jhipstersampleapplication/continent'], {
        queryParams: {
          page: this.page,
          size: this.itemsPerPage,
