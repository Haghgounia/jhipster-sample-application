...
describe('AssetStatus Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'jhipstersampleapplication/asset-status', component: AssetStatusComponent }]),
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.assetStatuses?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
