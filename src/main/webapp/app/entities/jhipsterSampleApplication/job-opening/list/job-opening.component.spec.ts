...
describe('JobOpening Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'jhipstersampleapplication/job-opening', component: JobOpeningComponent }]),
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.jobOpenings?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
