...
export class AssetCategoryComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.assetCategoryService
      ...
      .subscribe({
        next: (res: HttpResponse<IAssetCategory[]>) => {
  ...
  trackId(_index: number, item: IAssetCategory): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: IAssetCategory[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
    this.totalItems = Number(headers.get('X-Total-Count'));
    this.page = page;
    if (navigate) {
      this.router.navigate(['/jhipstersampleapplication/asset-category'], {
        queryParams: {
          page: this.page,
          size: this.itemsPerPage,
