...
describe('Country Service', () => {
  ...
  beforeEach(() => {
    ...
    elemDefault = {
      ...
      countryId: 0,
      countryName: 'AAAAAAA',
      countryEnglishName: 'AAAAAAA',
      countryFullName: 'AAAAAAA',
      countryEnglishFullName: 'AAAAAAA',
      countryIsoCode: 'AAAAAAA',
      nationality: 'AAAAAAA',
      englishNationality: 'AAAAAAA',
      isActive: 0,
      sortOrder: 0,
    };
  });
  ...
  describe('Service methods', () => {
      ...
      const returnedFromService = Object.assign(
        {
          ...
          countryId: 1,
          countryName: 'BBBBBB',
          countryEnglishName: 'BBBBBB',
          countryFullName: 'BBBBBB',
          countryEnglishFullName: 'BBBBBB',
          countryIsoCode: 'BBBBBB',
          nationality: 'BBBBBB',
          englishNationality: 'BBBBBB',
          isActive: 1,
          sortOrder: 1,
        },
        elemDefault
    ...
    describe('addCountryToCollectionIfMissing', () => {
      ...
      it('should add only unique Country to an array', () => {
        const countryArray: ICountry[] = [{ id: 123 }, { id: 456 }, { id: 88102 }];
