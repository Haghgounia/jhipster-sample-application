...
describe('EmployeeContact Management Component', () => {
  let comp: EmployeeContactComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'jhipstersampleapplication/employee-contact', component: EmployeeContactComponent }]),
      ...
      .overrideTemplate(EmployeeContactComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.employeeContacts?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
