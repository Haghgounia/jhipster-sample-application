...
import com.mycompany.myapp.service.VillageQueryService;
...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.Village}.
 */
@RestController
@RequestMapping("/api")
public class VillageResource {
    ...
    private static final String ENTITY_NAME = "jhipsterSampleApplicationVillage";
