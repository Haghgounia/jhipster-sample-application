...
import com.mycompany.myapp.service.AssetCategoryQueryService;
...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.AssetCategory}.
 */
@RestController
@RequestMapping("/api")
public class AssetCategoryResource {
    ...
    private static final String ENTITY_NAME = "jhipsterSampleApplicationAssetCategory";
    ...
    public ResponseEntity<AssetCategoryDTO> updateAssetCategory(
        ...
        AssetCategoryDTO result = assetCategoryService.update(assetCategoryDTO);
        return ResponseEntity
            .ok()
