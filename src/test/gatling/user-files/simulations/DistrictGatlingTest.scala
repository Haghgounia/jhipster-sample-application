...
class DistrictGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the District entity")
        ...
        .repeat(2) {
            ...
            .get("/services/jhipstersampleapplication/api/districts")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new district")
            .post("/services/jhipstersampleapplication/api/districts")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "districtId":"0"
                , "districtCode":"SAMPLE_TEXT"
                , "districtName":"SAMPLE_TEXT"
                , "districtEnglishName":"SAMPLE_TEXT"
                }""")).asJson
            .check(status.is(201))
            ...
            .repeat(5) {
                ...
                .get("/services/jhipstersampleapplication${new_district_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created district")
            .delete("/services/jhipstersampleapplication${new_district_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
